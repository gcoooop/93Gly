...
post = Post.create(title: "Dumbbell Nebula", caption: "Photo credit to gcoooop", photographer_id: 1)
...
post = Post.create(title: "M2", caption: "Photo credit to gcoooop", photographer_id: 1)
file = open('https://s3-us-west-1.amazonaws.com/93gly-seeds/M2.PNG')
post.photo.attach(io: file, filename: "M2.PNG")

post = Post.create(title: "Crab Nebula", caption: "Photo credit to gcoooop", photographer_id: 1)
file = open('https://s3-us-west-1.amazonaws.com/93gly-seeds/crab_nebula.PNG')
post.photo.attach(io: file, filename: "crab_nebula.PNG")

post = Post.create(title: "Bode's Galaxy", caption: "Photo credit to gcoooop", photographer_id: 1)
...
post = Post.create(title: "Bubble Nebula", caption: "Photo credit to u/firemandan666", photographer_id: 2)
...
post = Post.create(title: "Fighting Dragons of Ara", caption: "Photo credit to u/OkeWoke", photographer_id: 2)
...
post = Post.create(title: "Hidden Galaxy", caption: "Photo credit to u/burscikas", photographer_id: 2)
file = open('https://s3-us-west-1.amazonaws.com/93gly-seeds/hidden_galaxy.jpg')
post.photo.attach(io: file, filename: "hidden_galaxy.jpg")

post = Post.create(title: "Orion Nebula", caption: "Photo credit to u/_indeed_", photographer_id: 4)
...
post = Post.create(title: "Tarantula Nebula", caption: "Photo credit to u/Windston57", photographer_id: 4)
...
post = Post.create(title: "Eastern Veil Nebula", caption: "Photo credit to u/Scaletto", photographer_id: 5)
file = open('https://s3-us-west-1.amazonaws.com/93gly-seeds/veil_nebula.jpg')
post.photo.attach(io: file, filename: "veil_nebula.jpg")

post = Post.create(title: "Wizard Nebula", caption: "Photo credit to u/japzz", photographer_id: 5)
